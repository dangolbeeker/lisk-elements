...
describe('TransactionResouce', () => {
	...
	describe('#constructor', () => {
		it('should throw error without LiskAPI input', () => {
			return (() => new TransactionResource()).should.throw('Require LiskAPI instance to be initialized.');
		});
		...
		it('should have correcrt full path', () => {
			return resource.resourcePath.should.eql(`${defaultBasePath}/api${defaultPath}`);
		});
